...
export const DessertData: Record<string, DessertDataType> = {
  ...
  aunchan: {
    ...
    description:
      "อัญชันมักจะใส่ชุดโทนสีน้ำเงิน หรือม่วงที่ดูน่าเศร้า เล่ากันว่าเธอเป็นสตรีมีการศึกษาสูงจากเมืองหลวง แต่เมื่อสามีเสียชีวิต เธอจึงใส่ชุดนี้เพื่อไว้ทุกข์แก่เขา",
    image: aunchan,
